...
async function contentify(channel, content) {
	...
	if (content instanceof Discord.MessageEmbed) {
		if (!(await cacheManager.channels.clientHasPermission({ id: channel.id, guild_id: channel.guild ? channel.guild.id : undefined }, Discord.Constants.PERMISSION_FLAGS["EMBED_LINKS"]))) {
