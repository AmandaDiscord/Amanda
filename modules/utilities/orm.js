...
const Channels = new Model("channels", { id: str, type: num, guild_id: str, name: str }, ["id"], { useBuffer: true })
...
const Guilds = new Model("guilds", { id: str, name: str, icon: str, member_count: num, owner_id: str, permissions: str, region: str, added_by: str }, ["id"], { useBuffer: true })
