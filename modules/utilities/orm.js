...
const ChannelOverrides = new Model("channel_overrides", { id: str, type: num, allow: str, deny: str, guild_id: str, channel_id: str }, ["channel_id", "id"], { useBuffer: true, bufferSize: 5000 })
const Channels = new Model("channels", { id: str, type: num, guild_id: str, name: str, rtc_region: str }, ["id"], { useBuffer: true, bufferSize: 5000 })
...
const Roles = new Model("roles", { id: str, permissions: str, guild_id: str }, ["id"], { useBuffer: true, bufferSize: 5000 })
...
const VoiceStates = new Model("voice_states", { guild_id: str, channel_id: str, user_id: str }, ["user_id"], { useBuffer: true, bufferSize: 300 })
