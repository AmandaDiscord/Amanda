...
const ChannelOverrides = new Model("channel_overrides", { id: str, type: num, allow: str, deny: str, guild_id: str, channel_id: str }, ["channel_id", "id"], { useBuffer: true })
const Channels = new Model("channels", { id: str, type: num, guild_id: str, name: str, rtc_region: str }, ["id"], { useBuffer: true, bufferSize: 100 })
...
const Guilds = new Model("guilds", { id: str, name: str, icon: str, member_count: num, owner_id: str, permissions: str, region: str, added_by: str }, ["id"], { useBuffer: true, bufferSize: 100 })
...
const Roles = new Model("roles", { id: str, permissions: str, guild_id: str }, ["id"], { useBuffer: true, bufferSize: 100 })
