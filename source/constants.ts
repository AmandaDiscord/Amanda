...
export const lavalinkNodes = [] as Array<import("./types").InferModelDef<typeof import("./utils/orm")["db"]["tables"]["lavalink_nodes"]> & { id: string; resumeKey?: string; resumeTimeout?: number; password: string }>
